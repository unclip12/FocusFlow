...
export const HistoryIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0zM3 12a9 9 0 1118 0 9 9 0 01-18 0z" />
  </svg>
);
...
export const TrophyIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 18.75h-9m9 0a3 3 0 013 3h-15a3 3 0 013-3m9 0v-3.375c0-.621-.503-1.125-1.125-1.125h-.871M7.5 18.75v-3.375c0-.621.504-1.125 1.125-1.125h.872m5.007 0H9.497m5.007 0V5.625W12 2.25c-1.892 1.125-4.375 1.125-6.25 0L3 5.625v8.625c0 1.78.93 3.448 2.497 4.505" />
...
export const ChatBubbleLeftRightIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193-.34.027-.68.052-1.02.072v3.091l-3-3c-1.355 0-2.697-.056-4.024-.166-.37-.03-.736-.07-1.097-.118 1.51-.36 2.91-1.053 4.112-2.017C17.435 13.033 19.08 10.92 20.25 8.511zM16.156 2.921c-3.568-1.518-7.888.618-9.607 4.745-.467 1.12-.612 2.32-.42 3.48.235 1.423.91 2.72 1.928 3.736-.593 1.655-2.275 2.958-4.18 3.24-1.142.168-1.94-.877-1.33-1.87 1.113-1.816 1.206-3.92.262-5.693-.272-.512-.487-1.045-.64-1.594-1.524-5.51 1.656-11.178 7.142-12.69 5.487-1.512 11.117 1.698 12.641 7.207.142.513.246 1.035.31 1.563-.38-.528-.818-1.02-1.308-1.468-1.118-1.016-2.51-1.74-4.052-2.066-.926-.195-1.89-.195-2.816 0z" />
  </svg>
);
