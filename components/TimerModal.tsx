...
const TimerModal: React.FC<TimerModalProps> = ({ isOpen, onClose, onFinish, topic, targetMinutes }) => {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/20 backdrop-blur-sm p-4">
      <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl w-full max-w-[300px] p-6 animate-fade-in-up border border-indigo-100 dark:border-slate-700 relative overflow-hidden">
        
        {/* Progress Bar Background */}
        <div className="absolute top-0 left-0 h-1 bg-slate-100 dark:bg-slate-700 w-full">
